...
class Text(object):
    ...
    def get_width_x(self):
        return self.__x + self.text_obj.get_width()
...
class Button(object):
    def __init__(self, surface, border_height, border_width, color_bg=(0, 0, 0), text='None',
        ...
        self.__width = self.text.text_obj.get_width() + self.__border_width
        self.__height = self.text.text_obj.get_height() + self.__border_height
...
class InputPanel(object):
    def __init__(self, surface, width, height, path_font, max_symbols=10, color_bg=(0, 0, 0), color_text=(255, 255, 255)):
        self.__surface = surface
        self.__width = width
    ...
    def draw(self, x, y):
        ...
        self.__text_obj.change_text(self.__text_input_panel)
